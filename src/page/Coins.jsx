...
import pendantsProduct from "../Data/coinsRavindra"; // Importing pendants data
...
const Coins = () => {
  ...
  return (
    <div>
      <img
        src="https://www.yumpu.com/en/image/facebook/51530933.jpg"
        alt=""
      ...
      {selectedProduct ? (
        <div>
          ...
          <ProductDetail
            ...
            productList={pendantsProduct}
          />
        </div>
      ) : (
        <div>
          <h1 className="text-2xl font-bold mb-4">Coins Collection</h1>
